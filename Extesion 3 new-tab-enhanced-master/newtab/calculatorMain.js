				...
				if (operators[i].innerText == '*' || operators[i].innerText == '/') {
					...
					if (next.innerText.toString() && prev.innerText.toString()) {
						if (operators[i].innerText == '*') {
							var num = parseFloat(prev.innerText) * parseFloat(next.innerText);
							next.remove();
						...
						if (operators[i].innerText == '/') {
							var _num = parseFloat(prev.innerText) / parseFloat(next.innerText);
							next.remove();
				...
				if (operators[_i].innerText == '+' || operators[_i].innerText == '-') {
					...
					if (_next.innerText.toString() && _prev.innerText.toString()) {
						if (operators[_i].innerText == '+') {
							var _num2 = parseFloat(_prev.innerText) + parseFloat(_next.innerText);
							_next.remove();
						...
						if (operators[_i].innerText == '-') {
							var _num3 = parseFloat(_prev.innerText) - parseFloat(_next.innerText);
							_next.remove();
